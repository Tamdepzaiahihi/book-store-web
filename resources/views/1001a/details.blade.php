                    ...
                    <div class="row">
                       <div class="col-md-4 margin_bottom1">
                           <div class="product_box">
                               <figure><img src="../images/{{$product->productImage1}}" 
                                                style="height: 250px; width: 250px;"/>
                               </figure>
                               <h3>{{$product->productName}}</h3>                                 
                               <h3>Price: {{$product->productPrice}}</h3>
                               <h3>Details: {{$product->productDetails}}</h3>
                               <h3><a href="{{url('products')}}" class="btn btn-outline-primary" >Back</a></h3>
                               <h3> <a href="#" class="btn btn-outline-success">Add to cart</a></h3>
                           </div>
                        </div>                     
                       <div class="col-md-12">
